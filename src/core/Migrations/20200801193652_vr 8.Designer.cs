...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alterdata.Bimer.Core.Modelo.Email", b =>
                {
            ...
            modelBuilder.Entity("Alterdata.Bimer.Core.Modelo.Cliente", b =>
                {
                    ...
                    b.OwnsOne("Alterdata.Bimer.Core.ValueObjects.Impl.Login", "Login", b1 =>
                        {
                            b1.Property<int>("ClienteIdentificador")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                    ...
                    b.OwnsOne("Alterdata.Bimer.Core.ValueObjects.Impl.Role", "Role", b1 =>
                        {
                            b1.Property<int>("ClienteIdentificador")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                    ...
                    b.OwnsOne("Alterdata.Bimer.Core.ValueObjects.Impl.Senha", "Senha", b1 =>
                        {
                            b1.Property<int>("ClienteIdentificador")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
            ...
            modelBuilder.Entity("Alterdata.Bimer.Core.Modelo.Email", b =>
                {
                    b.OwnsOne("Alterdata.Bimer.Core.ValueObjects.Impl.EnderecoEmail", "EnderecoEmail", b1 =>
                        {
                            b1.Property<int>("EmailIdentificador")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                                .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);

                            b1.Property<string>("EnderecoEmailValue")
                                .HasColumnName("EnderecoEmail")
                                .HasColumnType("character varying(60)")
                                .HasMaxLength(60);

                            b1.HasKey("EmailIdentificador");

                            b1.ToTable("Contatos");

                            b1.WithOwner()
                                .HasForeignKey("EmailIdentificador");
                        });
                });
