namespace Alterdata.Bimer.WebAPI.Parsers
{
    ...
    public static class EmpresaParser
    {
        ...
        /// </summary>
        /// <param name="empresa">O DTO a ser convertido.</param>
        ...
        public static IEnumerable<Empresa> Converter(List<ContratoRetornoEmpresa> listaContratoRetornoEmpresa)
        {
            return listaContratoRetornoEmpresa.Select(contrato => Converter(contrato));
        }
    }
}